...
static void kthread_init(kthread_context_t *k_ctx)
{
	...
	//Seems like I will need this to target a CPU? Or to get the curr kthread running?
...
extern void gtthread_app_init(int scheduler_type)
{
	...
	//Setting the scheduler type as a shared info	
	ksched_shared_info.scheduler_type = scheduler_type;
